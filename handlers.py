...
def show_notification(update, context):
    ...
    if reply:
        ...
        context.bot.send_message(chat_id=update.effective_chat.id, text="No notification exists")


def del_notification(update, context):
